...
export default function About() {
  return (
    <div className="contentpages">
      ...
      Hi there! I'm Analia, a full-stack web developer with a background in digital marketing and a keen interest in front-end development. <br></br>Some of my past work can be found under the <strong>Portfolio</strong> tab, and my skillset can be found under the <strong>Resume</strong> tab.  <br></br>If you have any questions, please feel free to contact me!
      </p>
    </div>
  );
}

...
import twitimg from '../images/twitterlogo.png'
    ...
    <footer className="footer">
      <div className="container text-center mb-5">
        <div className="footerlogos">
          ...
          <a href="https://stackexchange.com/users/22293447/analia"><img src={twitimg} className="logos" style={{maxWidth:'35px', margin:'10px',opacity:"0.4"}} alt="twitter logo"></img></a>
        </div>
